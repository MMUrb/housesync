...
-- ----------------------------------------------------------------------------
-- ACCOUNT SETTINGS (private per-user reminder opt-ins)
-- Kept separate from `profiles` so housemates can NEVER read your notification
-- preferences. RLS allows access to the owner only.
-- ----------------------------------------------------------------------------
...
-- Phone capture and SMS reminders were removed in migration 0035. SMS never
-- shipped, so the phone columns and the phone_verifications table are gone.
